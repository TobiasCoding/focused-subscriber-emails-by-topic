...
with open(strong_words_path, 'w') as file:
  file.write('"FISCALIA FEDERAL", "FISCALÍA FEDERAL", "JUZGADO FEDERAL", "CÁMARA FEDERAL DE LA PLATA", "CAMARA FEDERAL DE LA PLATA", "LA PLATA", "DEPARTAMENTO JUDICIAL", ""ELECTORAL", "INTERNA", "CONTABLE", "APODERADO", "PARTIDO", "LIBERTAD AVANZA", " PRO ", " UCR", "PERONISTA", "RADICAL", "URNA", "URNAS", "ELECTORES", "VOTANTES", "ELECCIONES"')
